      ...
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          <div className="flex items-center justify-between space-x-4">
            <h2 className="text-lg font-medium text-gray-900">Последно добавени събития</h2>
            <a href="#" className="whitespace-nowrap text-sm font-medium text-blue-600 hover:text-blue-500">
            Виж всички
